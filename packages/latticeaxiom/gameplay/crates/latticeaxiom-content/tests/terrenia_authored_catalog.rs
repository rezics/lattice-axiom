...
const SEMANTIC_JSON: &str =
    include_str!("../../../../../terrenia/blocks/data/semantic-registry-v1.json");
...
const D3_IDS: &str = include_str!("../../../../../terrenia/blocks/data/goldens/d3-block-ids.txt");
const D4_IDS: &str = include_str!("../../../../../terrenia/blocks/data/goldens/d4-block-ids.txt");
const D7_IDS: &str = include_str!("../../../../../terrenia/blocks/data/goldens/d7-block-ids.txt");
const D9_IDS: &str = include_str!("../../../../../terrenia/blocks/data/goldens/d9-block-ids.txt");
