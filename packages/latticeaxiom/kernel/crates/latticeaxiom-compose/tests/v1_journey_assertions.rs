...
/// In-memory production host steps evidenced by existing tests.
/// These flags are not a durable-writer, checkpoint, or crash-recovery claim.
const MEMORY_HOST_IMPLEMENTED_STEPS: [&str; 10] = [
    "create",
    "spawn",
    "explore",
    "enter-cave",
