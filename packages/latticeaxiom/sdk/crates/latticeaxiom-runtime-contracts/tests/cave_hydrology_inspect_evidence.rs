...
const AUTHORED_BINDINGS: &str = concat!(
    ...
    "/../../../../terrenia/worldgen/data/authored-block-bindings-v1.json"
);
const AUTHORED_BIOMES: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../../../../terrenia/worldgen/data/authored-biomes-v1.json"
);
const AUTHORED_LAYERS: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../../../../terrenia/worldgen/data/authored-natural-layers-v1.json"
);
