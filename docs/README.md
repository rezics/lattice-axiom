...
3. [已選技術棧與採用邊界](foundations/technology-stack.md)
4. [Nickel 驅動的套件系統與雙實現路徑](architecture/package-management.md)
5. [模組核心與宣告式組合](architecture/module-composition.md)
6. [版本、相依性與相容性架構](architecture/versioning-and-compatibility.md)
7. [世界持久化與 RocksDB World Store](architecture/world-persistence.md)
8. [可組合世界生成架構](architecture/world-generation.md)
9. [可組合洞穴生成架構](architecture/cave-generation.md)
10. [渲染架構與擴充邊界](architecture/rendering.md)
11. [實體、物理與表現層](architecture/entity-physics-presentation.md)
12. [資產管線與模型語義](architecture/asset-semantics.md)
13. [物理資產與局部形變創作](architecture/physical-authoring.md)
14. [第一個可玩 demo 路線圖](planning/roadmap-first-demo.md)
15. [待決問題](planning/open-questions.md)

## 文件地圖

| 分類 | 用途 | 現有內容 |
| --- | --- | --- |
| 基礎 | 說明遊戲目前想成為什麼、如何開發、採用哪些技術，以及詞彙如何使用 | [專案願景](foundations/project-vision.md)、[開發策略](foundations/development-strategy.md)、[技術棧](foundations/technology-stack.md)、[詞彙表](foundations/glossary.md) |
...
| 決策 | 保存已明確採納的重大方向、理由與後果 | [0001：領地優先](decisions/0001-territory-first-biome-driven-world-generation.md)、[0002：混合洞穴](decisions/0002-hybrid-cave-generation-composition.md)、[0003：無全域大版本](decisions/0003-no-global-version-package-scoped-compatibility.md)、[0004：領地委派](decisions/0004-territorial-delegation-for-spatial-generation.md)、[0005：Rust 與自研邊界](decisions/0005-rust-and-focused-build-boundary.md)、[0006：wgpu 門面](decisions/0006-wgpu-behind-rendering-facade.md)、[0007：Nickel 前端（已取代）](decisions/0007-nickel-as-composition-language.md)、[0008：雙實現路徑](decisions/0008-static-and-dynamic-realizations-share-one-graph.md)、[0009：RocksDB 權威快照](decisions/0009-rocksdb-authoritative-world-snapshots.md)、[0010：Nickel 驅動套件系統](decisions/0010-nickel-driven-package-system.md)、[0011：右手 Z-up 世界座標](decisions/0011-right-handed-z-up-world-coordinates.md)、[0012：latticeaxiom 命名約定](decisions/0012-latticeaxiom-naming-convention.md) |
