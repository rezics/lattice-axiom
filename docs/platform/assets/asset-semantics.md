...
document_id: platform.assets.asset-semantics
...
[SemanticTag／Map、StateProperty、Affordance、Predicate与Role](../registration/semantic-registration.md)
...
- [Bevy 執行期架構](../runtime/game-engine-runtime.md)
- [渲染架構](../rendering/rendering.md)
- [實體、物理與表現層](../runtime/entity-physics-presentation.md)
- [物理資產與局部形變創作](../content/physical-authoring.md)
