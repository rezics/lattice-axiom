...
document_id: platform.composition.module-composition
...
完整schema、Nickel authoring与fallback算法见[语义注册架构](../registration/semantic-registration.md)。
...
- [Bevy 執行期](../runtime/game-engine-runtime.md)
- [版本與相容性](../compatibility/versioning-and-compatibility.md)
