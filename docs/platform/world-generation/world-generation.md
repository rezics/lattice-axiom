---
title: 可組合世界生成架構
document_id: platform.world-generation.world-generation
...
玩家建造、採掘、工業污染和文明演化不屬於可任意重算的基礎生成結果。區塊第一次生成並提交後，快照即成為該空間的權威；生成器更新只影響尚未物化或被顯式 regenerate 的範圍。持久化細節見[世界持久化與 RocksDB World Store](../world-storage/world-persistence.md)。
...
完整模型見[版本、相依性與相容性架構](../compatibility/versioning-and-compatibility.md)與[決策 0003](../../decisions/0003-no-global-version-switch.md)。
...
- [版本、相依性與相容性架構](../compatibility/versioning-and-compatibility.md)
- [世界持久化與 RocksDB World Store](../world-storage/world-persistence.md)
- [Bevy 模組與內容組合](../composition/module-composition.md)
