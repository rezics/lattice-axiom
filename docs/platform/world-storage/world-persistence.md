...
身份。完整开始页与preflight contract见[World目录、开始页与安全生命周期](../../packages/latticeaxiom/front-end/world-lifecycle-and-start-ui.md)。
...
- [套件與 ABI 版本](../compatibility/versioning-and-compatibility.md)
