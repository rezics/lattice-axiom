...
document_id: platform.runtime.game-engine-runtime
...
详见[渲染架构](../rendering/rendering.md)。
...
详见[设置架构](../../packages/latticeaxiom/settings/settings-and-configuration.md)与[诊断／检查架构](../observability/diagnostics-inspection-and-debug-visualization.md)。
...
- [套件內核](../package-kernel/package-management.md)
- [模組組合](../composition/module-composition.md)
- [語義註冊、內容判定與選擇](../registration/semantic-registration.md)
- [原生模組 ABI](../native-abi/native-module-abi.md)
- [渲染架構](../rendering/rendering.md)
- [世界持久化](../world-storage/world-persistence.md)
- [設定與配置](../../packages/latticeaxiom/settings/settings-and-configuration.md)
- [診斷、檢查與除錯可視化](../observability/diagnostics-inspection-and-debug-visualization.md)
- [World 生命週期與開始頁](../../packages/latticeaxiom/front-end/world-lifecycle-and-start-ui.md)
