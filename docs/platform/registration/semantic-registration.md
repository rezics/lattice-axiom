...
document_id: platform.registration.semantic-registration
...
- [模組與註冊清單](../composition/module-composition.md)
- [版本與相容性](../compatibility/versioning-and-compatibility.md)
- [世界持久化](../world-storage/world-persistence.md)
- [世界生成](../world-generation/world-generation.md)
- [資產語義](../assets/asset-semantics.md)
