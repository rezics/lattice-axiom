...
document_id: delivery.plan.terrenia-science-magic-and-relations
...
它不改写 [第一個可玩 demo](../roadmaps/first-demo.md) 的 D0–D10 出场门禁，也不授权把 Minecraft
...
[开始页](../../packages/latticeaxiom/front-end/world-lifecycle-and-start-ui.md)。本页不批准同 App 切 Playing。
