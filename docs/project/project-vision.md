---
title: 專案願景與設計支柱
document_id: project.project-vision
...
这些问题集中在[待决问题](../delivery/open-questions.md)，由 vertical slice、old-binary fixtures 与创作者测试回答。
...
- [執行期架構](../platform/runtime/game-engine-runtime.md)
