...
No user-configurable settings。tier、class、durability、mining modifier 与 recipes 是 authoritative
content/balance data；玩家输入绑定属于 `@latticeaxiom/input`，world rules 属于
`@terrenia/gameplay`。
