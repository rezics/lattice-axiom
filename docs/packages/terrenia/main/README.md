...
No user-configurable settings。`terrenia` 只聚合 closure、grants 与 role bindings；把 setting
挂在 root 会掩盖真实 owner。Terrenia 的 world rules、presentation preferences 与 future feature
settings 分别由对应子 packages 注册。
